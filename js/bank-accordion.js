...
.route-plan-wrap{margin-top:16px}.route-plan-label{font-size:11px;font-weight:800;color:var(--muted);margin-bottom:8px}.route-plan-image{display:block;max-width:100%;width:auto;max-height:480px;object-fit:contain;margin:0 auto;background:#fff;border:1px solid var(--line);border-radius:12px;padding:10px}.route-plan-missing{padding:12px;border:1px dashed var(--line);border-radius:10px;color:var(--muted);font-size:12px;background:#fff}
